...
class Blockchain:
    ...
    def get_balance(self, sender=None):
        ...
        # spend coins before the transaction was confirmed + included 
        # in a block
    ...
    # One required one (transaction_amount) 
    # and one optional one (last_transaction)
    # The optional one is optional because it has a default value => [1]

    def add_transaction(self, recipient, sender,
                        signature, amount=1.0, is_receiving=False):
